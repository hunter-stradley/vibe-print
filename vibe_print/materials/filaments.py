...
Based on manufacturer specifications, knowledge bases, and community testing.
Optimized for compatible FDM printers.
"""
...
class FilamentProfile:
    ...
    def get_design_recommendations(self) -> List[str]:
        ...
        if self.material_type == FilamentType.TPU:
            ...
            recs.append("Use direct extruder feed (no multi-material system)")

        if self.requires_enclosure:
            recs.append("This material works best with an enclosed printer")
...
# =============================================================================
# Pre-defined Filament Profiles
# =============================================================================

BASIC_PLA = FilamentProfile(
    name="Basic PLA",
    brand="Generic",
    ...
    max_print_speed=300.0,  # High-speed printers can go fast with PLA
    recommended_speed=150.0,
    first_layer_speed=30.0,
    max_volumetric_flow=21.0,  # Quality PLA flows well
...
PETG_TRANSLUCENT = FilamentProfile(
    ...
    notes=[
        ...
        "Use textured plate with glue stick for best adhesion",
        "Let cool completely before removing from bed",
    ],
    cost_per_kg=30.0,
)

PC_BLEND = FilamentProfile(
    name="PC Blend",
    brand="Generic",
    ...
    notes=[
        "Open-frame printers can print PC Blend with limitations",
        "Use textured PEI plate with glue stick",
        "Smaller parts work better on open-frame printers",
        "Keep ambient temp > 18C to avoid thermal runaway",
...
GENERIC_PETG = FilamentProfile(
    ...
    notes=[
        ...
        "Start at 235C and adjust in 5C increments",
...
GENERIC_TPU_95A = FilamentProfile(
    ...
    requires_enclosure=False,
    requires_hardened_nozzle=False,
    ams_compatible=False,  # TPU 95A doesn't work with multi-material systems
    bed_adhesion="good",
    warping_tendency="none",
    stringing_tendency="high",

    notes=[
        "Do NOT use with multi-material systems - feed directly",
        "Disable dynamic flow calibration in slicer",
        "Print one object at a time to minimize travel",
        "Use low retraction (0.5mm) and slow speed (20mm/s)",
        "Max volumetric flow is 3.2 mm3/s for generic TPU",
...
FILAMENT_PROFILES: Dict[str, FilamentProfile] = {
    "basic_pla": BASIC_PLA,
    "pla": BASIC_PLA,
    "bambu_pla": BASIC_PLA,  # Backwards compatibility
    "bambu_basic_pla": BASIC_PLA,
    "petg_translucent": PETG_TRANSLUCENT,
    "bambu_petg": PETG_TRANSLUCENT,
    "bambu_petg_translucent": PETG_TRANSLUCENT,
    "pc_blend": PC_BLEND,
    "prusa_pc": PC_BLEND,
    "prusa_pc_blend": PC_BLEND,
    "prusament_pc": PC_BLEND,
...
def suggest_filament(
    ...
    if needs_heat_resistance and needs_strength:
        suggestions.append("pc_blend")
    elif needs_outdoor and needs_strength:
        suggestions.append("petg_translucent")
        suggestions.append("pc_blend")
        ...
        suggestions.append("basic_pla")  # Default choice
