"""
Nozzle Profiles - FDM nozzle configurations and recommendations.

Based on common FDM printer specifications and community best practices.
"""
...
class NozzleProfile:
    """
    Nozzle configuration for FDM printers.
...
# Registry of all supported nozzles
SUPPORTED_NOZZLES: Dict[str, NozzleProfile] = {
    "0.2": NOZZLE_02_SS,
    "0.2_ss": NOZZLE_02_SS,
...
def get_nozzle_profile(diameter: float, hardened: bool = False) -> Optional[NozzleProfile]:
    ...
    return SUPPORTED_NOZZLES.get(key)
