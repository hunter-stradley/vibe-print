"""
BambuStudio MCP Server - Main server with all tools registered.
...
@mcp.tool(
    name="bambustudio_analyze_model",
    annotations={
...
async def bambustudio_analyze_model(params: AnalyzeModelInput) -> str:
    """
    ...
    """
    from bambustudio_mcp.models.analyzer import ModelAnalyzer
...
async def bambustudio_scale_model(params: ScaleModelInput) -> str:
    """
    ...
    """
    from bambustudio_mcp.models.scaler import ModelScaler
...
async def bambustudio_slice_model(params: SliceModelInput) -> str:
    """
    Slice a 3D model using BambuStudio CLI to generate printable G-code.
    ...
    from bambustudio_mcp.slicer.parameters import BUILTIN_PRESETS, SlicingParameters
...
async def bambustudio_list_presets() -> str:
    """
...
@mcp.tool(
    name="bambustudio_test_printer_connection",
    annotations={
...
async def bambustudio_test_printer_connection(params: PrinterConnectionInput) -> str:
    """
    Test connection to a Bambu Lab printer in LAN mode.
    ...
    """
    from bambustudio_mcp.printer.mqtt_client import test_printer_connection
...
@mcp.tool(
    name="bambustudio_get_printer_status",
    annotations={
...
async def bambustudio_get_printer_status() -> str:
    """
    Get current status of the connected Bambu printer.

    Returns temperatures, print progress, and operational state.
    Requires environment variables: BAMBU_PRINTER_IP, BAMBU_ACCESS_CODE, BAMBU_SERIAL

    Returns:
        JSON with printer status including temperatures, progress, and state
    """
    from bambustudio_mcp.printer.controller import PrinterController
...
@mcp.tool(
    name="bambustudio_control_print",
    annotations={
...
async def bambustudio_control_print(action: str) -> str:
    """
...
@mcp.tool(
    name="bambustudio_capture_camera",
    annotations={
...
async def bambustudio_capture_camera(params: CameraInput) -> str:
    ...
    """
    from bambustudio_mcp.camera.stream import CameraStream
...
@mcp.tool(
    name="bambustudio_analyze_print_quality",
    annotations={
...
async def bambustudio_analyze_print_quality() -> str:
    """
    ...
    """
    from bambustudio_mcp.camera.stream import CameraStream
    from bambustudio_mcp.camera.detector import DefectDetector
...
@mcp.tool(
    name="bambustudio_create_iteration",
    annotations={
...
async def bambustudio_create_iteration(
    model_name: str,
    model_path: str,
...
@mcp.tool(
    name="bambustudio_record_outcome",
    annotations={
...
async def bambustudio_record_outcome(params: RecordOutcomeInput) -> str:
    """
...
@mcp.tool(
    name="bambustudio_get_recommendations",
    annotations={
...
async def bambustudio_get_recommendations(
    model_name: str,
...
@mcp.tool(
    name="bambustudio_get_model_history",
    annotations={
...
async def bambustudio_get_model_history(params: IterationInput) -> str:
    """
...
@mcp.tool(
    name="bambustudio_parse_requirements",
    annotations={
...
async def bambustudio_parse_requirements(params: GenerateModelInput) -> str:
    """
    ...
    try:
        ...
        if params.target_dimension_mm:
            from bambustudio_mcp.generator.requirements import Dimension
...
@mcp.tool(
    name="bambustudio_analyze_reference_image",
    annotations={
...
async def bambustudio_analyze_reference_image(params: AnalyzeImageInput) -> str:
    """
    ...
    """
    from bambustudio_mcp.generator.image_analyzer import ImageAnalyzer
...
@mcp.tool(
    name="bambustudio_list_templates",
    annotations={
...
async def bambustudio_list_templates() -> str:
    """
    ...
    """
    from bambustudio_mcp.generator.templates import template_library
...
@mcp.tool(
    name="bambustudio_generate_from_template",
    annotations={
...
async def bambustudio_generate_from_template(params: GenerateFromTemplateInput) -> str:
    """
...
@mcp.tool(
    name="bambustudio_generate_parametric",
    annotations={
...
async def bambustudio_generate_parametric(params: GenerateModelInput) -> str:
    """
    ...
    """
    from bambustudio_mcp.generator.requirements import RequirementsParser
    from bambustudio_mcp.generator.parametric import ParametricGenerator
...
async def bambustudio_ai_generate(params: AIGenerateInput) -> str:
    """
    ...
    For functional parts, use bambustudio_generate_parametric instead.
...
async def bambustudio_ai_status(job_id: str) -> str:
    """
    Check the status of an AI model generation job.

    Args:
        job_id: The job ID returned from bambustudio_ai_generate
...
class DesignReviewInput(BaseModel):
    ...
    material: str = Field(default="Bambu Basic PLA", description="Material to use")
...
@mcp.tool(
    name="bambustudio_list_materials",
    annotations={
...
async def bambustudio_list_materials() -> str:
    """
    List all available filament profiles with their properties.

    Returns profiles for common materials including Bambu PLA, PETG, PC, and TPU.
    ...
    """
    from bambustudio_mcp.materials.filaments import list_filament_profiles, get_filament_profile
...
async def bambustudio_list_nozzles() -> str:
    """
    List all nozzle sizes available for A1/A1 Mini with recommendations.
    ...
    """
    from bambustudio_mcp.materials.nozzles import A1_NOZZLES
...
@mcp.tool(
    name="bambustudio_start_guided_workflow",
    annotations={
...
async def bambustudio_start_guided_workflow(params: StartWorkflowInput) -> str:
    """
    ...
    """
    from bambustudio_mcp.wizard.guided_workflow import GuidedWorkflow
...
@mcp.tool(
    name="bambustudio_review_design",
    annotations={
...
async def bambustudio_review_design(params: DesignReviewInput) -> str:
    """
    ...
    """
    from bambustudio_mcp.wizard.design_review import DesignReviewer
...
@mcp.tool(
    name="bambustudio_review_slicing",
    annotations={
...
async def bambustudio_review_slicing(params: SlicingReviewInput) -> str:
    """
    ...
    from bambustudio_mcp.materials.filaments import get_filament_profile
    ...
    try:
        ...
        if profile:
            if not profile.ams_compatible:
                notes.append(f"{profile.name} must be fed directly, not via AMS")
...
@mcp.tool(
    name="bambustudio_optimize_for_material",
    annotations={
...
async def bambustudio_optimize_for_material(params: MaterialOptimizeInput) -> str:
    """
...
@mcp.tool(
    name="bambustudio_get_nozzle_recommendation",
    annotations={
...
async def bambustudio_get_nozzle_recommendation(
    ...
    """
    from bambustudio_mcp.materials.nozzles import get_recommended_nozzle
...
@mcp.tool(
    name="bambustudio_parse_novice_description",
    annotations={
...
async def bambustudio_parse_novice_description(description: str) -> str:
    """
    ...
    """
    from bambustudio_mcp.wizard.novice_parser import parse_novice_description
